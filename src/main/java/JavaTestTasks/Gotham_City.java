...
Should you go on your own, or should you call a superhero to help
you fight the crime? If there are less than 5, you can handle this
on your own, if there are 5-10, you will want to go with Batman for backup,
and if there are more than 10,
you should stay where it is safe and let Batman handle this on his own!

Task:
Determine whether you need to call backup based
on the total number of criminals being reported.

Input Format:
An integer that represents the total
number of criminals present at the scene.
...
public class Gotham_City {
    public static void main(String[] args) {
        ...
        if (number < 5){System.out.println("I got this!");}
        else if (number>=5 & number <=10){System.out.println("Help me Batman");}
